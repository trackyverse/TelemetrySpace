...
![plot of chunk trace plots and post dist](trace plots and post dist-1.png)
...
![plot of chunk trace plots and post dist latent](trace plots and post dist latent-1.png)
...
![plot of chunk trace plots and post dist latent](trace plots and post dist latent-2.png)
...
![plot of chunk plot posteriors](plot posteriors-1.png)

``` r
p1
```

![plot of chunk plot posteriors](plot posteriors-2.png)
